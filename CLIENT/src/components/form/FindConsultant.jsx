...
const FindConsultant = () => {
  ...
  useEffect(() => {
    axios
      .get('https://myhealth-server-side.vercel.app/users')
      .then((res) => {
    ...
    <div>
      <div className="h-full w-full">
        ...
        <div className="flex ml-2">
          <FaSearch className="ml-1 mt-3 pt-1 text-xl absolute" />
          <input
            type="search"
            name="doctorname"
                  ...
                  <tr key={index}>
                    ...
                    <td className="p-4">
                      <a href="https://meet.google.com/" target="_blank" rel="noopener noreferrer">
                        <button disabled={!isMeetingTime} className="bg-orange-400 p-2 rounded">
                          Set Meeting
                        </button>
                      </a>
                    </td>
